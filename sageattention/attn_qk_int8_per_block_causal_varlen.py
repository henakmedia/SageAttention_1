...
@triton.jit
def _attn_fwd_inner(acc, l_i, m_i, q_fp32, q_scale, kv_len,
...
def _attn_fwd(Q, K, V, 
    ...
    acc, l_i, m_i = _attn_fwd_inner(acc, l_i, m_i, q_fp32, q_scale, kv_len,
                                    K_ptrs, K_scale_ptr, V_ptrs, stride_kn, stride_vn,
                                    start_m, H // num_kv_groups,
                                    BLOCK_M, HEAD_DIM, BLOCK_N,
                                    4 - STAGE, offs_m, offs_n)

    acc, l_i, _ = _attn_fwd_inner(acc, l_i, m_i, q_fp32, q_scale, kv_len,
                                K_ptrs, K_scale_ptr, V_ptrs, stride_kn, stride_vn,
                                start_m, H // num_kv_groups,
                                BLOCK_M, HEAD_DIM, BLOCK_N,
                                2, offs_m, offs_n)
